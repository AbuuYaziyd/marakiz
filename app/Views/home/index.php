                ...
                <div class="card border-grey border-lighten-3 m-0">
                    ...
                    <div class="card-footer">
                        <div class="text-center">
                            <div class="text-center">
                                <a href="<?= base_url('docs') ?>" class="btn btn-sm btn-outline-purple round"><?= session('lang') != 'ar' ? session('markaz')['value'] : session('markaz')['value_ar'] ?> | <?= session('lang') != 'ar' ? session('location')['value'] : session('location')['value_ar'] ?></a>
                            </div>
                        </div>
                    </div>
                </div>
