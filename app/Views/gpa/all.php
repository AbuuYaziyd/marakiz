...
<body>
    <?php foreach ($gpas as $gpkey => $gp) : ?>
        ...
        <div style="direction: <?= service('request')->getLocale() != 'ar' ? 'ltr' : 'rtl' ?>; width: 100%;">
            ...
            <div class="summary-section">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><b><?= $gp['subjects'] ?></b></td>
                            <td><b><?= round($gp['marks']) ?></b></td>
                            <?php if ($rs['final_status'] != 'gpa') : ?>
                                <td><b><?= lang('app.soon') ?></b></td>
                            <?php else : ?>
                                <td><b><?= $gp['final_position'] ?></b></td>
                            <?php endif ?>
                            <td><b><?= $gp['number_of_students'] ?? $c->stuCount($class['id']) ?></b></td>
                            <td><b><?= round($gp['gpa']) ?></b></td>
                            <?php if (session('lang') != 'ar') : ?>
                                <td><b><?= $gpa->grade(round($gp['gpa']))['name'] ?></td>
                            <?php else : ?>
                                <td><b><?= $gpa->grade(round($gp['gpa']))['name_ar'] ?></td>
                            <?php endif ?>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="footer">
                ...
                <div>
                    <?php if (session('lang') != 'ar') : ?>
                        <p><?= $taalim['extra'] ?></p>
                        <img src="<?= base_url($taalim['link'] ?? 'app-assets/images/signature.png') ?>" height="500px" alt="sign" />
                        <div class="signature-line"></div>
